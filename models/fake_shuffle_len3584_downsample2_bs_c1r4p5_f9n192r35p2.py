...
def build_model():
    ...
    conv1 = Conv2DLayer(incoming = pool0, num_filters = 192, filter_size = (1, 9),
    ...
    conv2 = Conv2DLayer(incoming = drop1, num_filters = 192, filter_size = (1, 1),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv2a = Conv2DLayer(incoming = bn2, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
    ...
    conv2b = Conv2DLayer(incoming = bn2a, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
                         W = conv2a.W, b = None,
                         nonlinearity = None)
    ...
    conv2c = Conv2DLayer(incoming = bn2b, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
                         W = conv2a.W, b = None,
                         nonlinearity = None)
    ...
    conv5 = Conv2DLayer(incoming = drop4, num_filters = 192, filter_size = (1, 1),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv5a = Conv2DLayer(incoming = bn5, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
                         W = nn.init.Normal(std = std), b = None,
                         nonlinearity = None)
    ...
    conv5b = Conv2DLayer(incoming = bn5a, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
                         W = conv5a.W, b = None,
                         nonlinearity = None)
    ...
    conv5c = Conv2DLayer(incoming = bn5b, num_filters = 192, filter_size = (1, 9),
                         stride = 1, border_mode = 'same',
                         W = conv5a.W, b = None,
                         nonlinearity = None)
