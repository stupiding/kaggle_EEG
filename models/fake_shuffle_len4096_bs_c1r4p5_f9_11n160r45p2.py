...
def build_model():
    ...
    conv1 = Conv2DLayer(incoming = l_in, num_filters = 160, filter_size = (1, 9),
    ...
    conv5a = Conv2DLayer(incoming = bn5, num_filters = 160, filter_size = (1, 11),
                         stride = 1, border_mode = 'same',
                         W = nn.init.Normal(std = std), b = None,
                         nonlinearity = None)
    ...
    conv5b = Conv2DLayer(incoming = bn5a, num_filters = 160, filter_size = (1, 11),
                         stride = 1, border_mode = 'same',
                         W = conv5a.W, b = None,
                         nonlinearity = None)
    ...
    conv5c = Conv2DLayer(incoming = bn5b, num_filters = 160, filter_size = (1, 11),
                         stride = 1, border_mode = 'same',
                         W = conv5a.W, b = None,
                         nonlinearity = None)
