...
train_series = [0, 1, 2, 3, 4, 5]  # list of series for training
valid_series = [6, 7]              # list of series for validation
...
test_data_params = {'section': 'test',
                    ...
                    'test_valid': True,   # to test the validation set or not when training is done
                    }
...
valid_freq = 20    # frequency to test the validation set (a small fraction)
