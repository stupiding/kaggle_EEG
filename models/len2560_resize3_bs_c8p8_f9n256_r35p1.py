...
def build_model():
    ...
    conv2 = Conv2DLayer(incoming = drop1, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv3 = Conv2DLayer(incoming = drop2, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv4 = Conv2DLayer(incoming = drop3, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv5 = Conv2DLayer(incoming = drop4, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv6 = Conv2DLayer(incoming = drop5, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    conv7 = Conv2DLayer(incoming = drop6, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
    ...
    pool7_large = Pool2DLayer(incoming = bn7, pool_size = (1, 8), stride = (1, 8))
    print 'pool7_large', nn.layers.get_output_shape(pool7_large)

    drop7_large = nn.layers.DropoutLayer(incoming = pool7_large, p = p)
    print 'drop7_large', nn.layers.get_output_shape(drop7_large)

    conv8 = Conv2DLayer(incoming = drop7, num_filters = 256, filter_size = (1, 9),
                        stride = 1, border_mode = 'same',
                        W = nn.init.Normal(std = std),
                        nonlinearity = None)
